...
function datepicker(locals) {
  ...
  var value = locals.value ? <Text style={controlLabelStyle}>{formattedValue}</Text> : null;
  ...
  return (
    <View style={formGroupStyle}>
      <TouchableNativeFeedback
        ...
        <View>
          {label}
          <View style={{borderRadius: textboxStyle.borderRadius, borderColor: textboxStyle.borderColor, borderWidth: textboxStyle.borderWidth, padding: textboxStyle.padding}}>
            {value}
          </View>
        </View>
      </TouchableNativeFeedback>
